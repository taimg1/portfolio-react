...
export const MainContext = () => {
    ...
    return(
        <div className="flex xl:mx-32 bg-white shadown rounded-lg lg:mt-10 mt-4 md:mx-16">
            ...
            <img src={require(".//assets/photo.jpg")} alt="programming"
                 className="2xl:w-[620px] xl:h-[680px] w-72  rounded-lg xl:pr-24 "/>
            <div className="pt-24 xl:pr-64">
                <section className="mb-3 ">
                    <h3 className="text-lg">Hello everyone, I am</h3>
                    <h1 className="text-5xl font-bold">Dwayne Johnson </h1>
